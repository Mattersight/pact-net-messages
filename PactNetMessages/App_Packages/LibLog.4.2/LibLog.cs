...
using PactNetMessages.Infrastructure.Logging;
...
namespace PactNetMessages.LibLog
#else
namespace PactNetMessages.Logging
#endif
{
#if LIBLOG_PROVIDERS_ONLY
    using PactNetMessages.LibLog.LogProviders;
#else
    using LogProviders;
#endif
#if !LIBLOG_PROVIDERS_ONLY
        ...
        static class LogProvider
    {
        ...
        internal static ILogProvider CurrentLogProvider { get { return _currentLogProvider; } }
    ...
    internal class LoggerExecutionWrapper : ILog
    {
        ...
        internal Logger WrappedLogger { get { return _logger; } }
...
#if LIBLOG_PROVIDERS_ONLY
namespace PactNetMessages.LibLog.LogProviders
#else
namespace PactNetMessages.Logging.LogProviders
#endif
{
